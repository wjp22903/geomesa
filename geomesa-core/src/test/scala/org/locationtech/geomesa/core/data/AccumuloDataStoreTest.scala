  ...
  "AccumuloDataStore" should {
    "create a data store" >> {
      ...
      "and create a schema" >> {
        ...
        "getTypeNames should contain newly created type" >> {
          ds.getTypeNames.toSeq must contain("testType")
        }
