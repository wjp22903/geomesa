...
function () {
    var _colors = [
        '#0a8300', '#7400e8', '#FF3399', '#8A5300', '#00B3FF',
        '#FF0000', '#00FF00', '#A168FC', '#0066FF', '#FF9900', '#667081', '#bebe40', '#9933FF', '#CC6600',
        '#753E80', '#0068FF', '#62A2CE',
    ...
    this.hexStringToRgbArray = function (hexString) {
        var hex = parseInt(hexString.replace('#', ''), 16);
        return [hex >> 16,
                hex >> 8 & 0xFF,
                hex & 0xFF];
    };
